...
export default function Login({  navigation }) {
    ...
    //deixar comentada a linha abaixo pois o comando enabled={Platform.OS === 'ios'} não esta sendo necessario
    //já que no meu celular android está ficando o teclado em cima do botao como no ios
